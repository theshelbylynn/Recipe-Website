    ...
    return(
       ...
       <div className="page-title">
        ...
        <div className="tutorial-container">
            ...
            <iframe id="tut-video" width="640" height="360" src="https://www.youtube.com/embed/EVy1H5KyJfQ" title="BEST AVOCADO SPINACH TOAST" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
